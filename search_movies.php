	         ...
	         <!-- End of Alert notification -->
               ...
               <!-- Movies -->
			    <div class="row">
						...
						$sql_limit = 'SELECT * FROM movies WHERE title="'.$search.'" LIMIT '.$first_page.' , '.$movies_per_page.'';
					...
					<!-- Movie Card -->
							<div  class=" col-md-4">
								...
								<div class="title-in">
									<h6><a style="font-size:15px;font-weight:bold;"href="#"><?php echo $row['title']?></a></h6>
									<?php 
									...
									<?php }else{ ?>
										<a  class="loginLink" style="color:yellow;"><i class="ion-android-star"></i><span>add favourite</span></a>
										<?php }?>
